<div class="flex flex-col md:flex-row items-center justify-between gap-4 pt-4 px-1">
    <span class="text-sm text-secondary text-center">
        ...
        sampai <span class="font-semibold text-foreground">{{ $students->lastItem() ?? 0 }}</span>
        dari <span class="font-semibold text-foreground">{{ number_format($students->total() ?? 0, 0, ',', '.') }}</span> siswa
    </span>
