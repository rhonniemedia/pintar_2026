        ...
        <form id="create-letter-active-form"
            ...
            <div class="block p-4 sm:p-6 overflow-visible bg-slate-50/30 flex-1 space-y-4">
                ...
                <div>
                    ...
                    {{-- Memanggil Komponen yang baru dibuat --}}
            ...
            {{-- Footer Modal --}}
            <div class="px-4 sm:px-6 py-3.5 sm:py-4 border-t border-border bg-slate-50/50 flex items-center justify-end gap-2 shrink-0 sm:rounded-b-2xl">
                <button type="button" @click="closeModal()"
