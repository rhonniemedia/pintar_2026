{{-- File: resources/views/pages/admin/students/letters/partials/_modal-create-good-conduct.blade.php --}}
<div x-data="{
        open: false,
        closeModal() {
            this.open = false;
    ...
    <x-ui.modal show="open" maxWidth="md">
        ...
        <div class="flex items-start sm:items-center justify-between gap-3 px-4 sm:px-6 py-4 sm:py-5 border-b border-border bg-slate-50/50 shrink-0">
            <div class="flex items-center gap-3 sm:gap-4 min-w-0">
                <div class="size-11 sm:size-12 rounded-full bg-primary/10 text-primary flex items-center justify-center shrink-0 shadow-sm">
                    <i data-lucide="badge-check" class="size-5 sm:size-6"></i>
                </div>
                <div class="min-w-0">
                    <h3 class="font-bold text-foreground text-base sm:text-lg leading-tight truncate">Kelakuan Baik</h3>
        ...
        <form id="create-letter-good-conduct-form"
            hx-post="{{ route('admin.students.letters.store-good-conduct') }}"
            ...
            x-data="{
                ...
                checkForm() {
                    const formEl = document.getElementById('create-letter-good-conduct-form');
