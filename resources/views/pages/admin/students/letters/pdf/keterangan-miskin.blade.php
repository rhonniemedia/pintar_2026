...
<x-pdf.document title="Surat Keterangan Tidak Mampu - {{ $school->name }}">
    <x-pdf.letterhead :school="$school" letter-title="SURAT KETERANGAN TIDAK MAMPU" :letter-number="$letterNumber" />
    ...
    <div class="content">
        ...
        <p>
            Adalah benar yang bersangkutan saat ini masih terdaftar dan aktif sebagai peserta didik {{ $school->name }} <strong>yang termasuk golongan siswa tidak mampu.</strong>
        </p>
        <p>
