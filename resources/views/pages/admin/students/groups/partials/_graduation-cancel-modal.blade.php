...
<div id="modal-container"
    ...
    <div class="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden shadow-2xl">
        ...
        {{-- Form --}}
        <form action="{{ route('admin.students.group.graduation.cancel', $classGroup->id) }}" method="POST"
            @submit="saving = true"
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <div class="flex-1 flex items-center justify-center">
                    <p class="text-sm text-secondary text-center py-8">Belum ada siswa yang diproses kelulusannya di rombel ini.</p>
                </div>
                @else
                <!-- Table Controls -->
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="border-b border-border">
                                ...
                                <th class="pb-3 pt-1 text-sm font-bold text-foreground">NIS</th>
                                <th class="pb-3 pt-1 text-sm font-bold text-foreground">Status</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-border/50 hover:bg-slate-50 transition-colors"
                                ...
                                <td class="py-3 text-sm">
                                    <span class="px-2 py-0.5 rounded {{ $row->status === 'graduated' ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600' }} font-bold text-xs">
                                        {{ $row->status === 'graduated' ? 'Lulus' : 'Tidak Lulus' }}
                                    </span>
                                </td>
            ...
            <div class="px-6 py-4 border-t border-border bg-gray-50/50 flex items-center justify-end shrink-0 gap-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <!-- Tombol Simpan dengan Loading Spinner (Menggunakan gaya Error/Merah untuk Batal Kelulusan) -->
                    ...
                    <button type="submit"
                        ...
                        <!-- Icon Alert/Trash (normal) menggunakan x-show -->
