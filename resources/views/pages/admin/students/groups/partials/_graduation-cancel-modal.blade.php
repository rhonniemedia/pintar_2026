                    ...
                    <div class="flex-1 overflow-auto border-y border-border/50">
                        <table class="w-full text-left border-collapse relative min-w-[550px]">
                            <thead class="sticky top-0 z-10 bg-white/95 backdrop-blur-sm shadow-sm">
                                <tr>
                                    <th class="py-3 pl-4 pr-2 text-sm font-bold text-secondary uppercase tracking-wider w-5/12">Peserta Didik</th>
                                    <th class="px-2 py-3 text-sm font-bold text-secondary uppercase tracking-wider w-3/12">NIS</th>
                                    <th class="px-2 py-3 text-sm font-bold text-secondary uppercase tracking-wider w-3/12">Status</th>
                                    <th class="py-3 pl-2 pr-4 text-right w-1/12">
