                    ...
                    <table class="w-full text-left border-collapse relative">
                        <thead class="sticky top-0 z-10 bg-white/95 backdrop-blur-sm">
                            <tr class="border-b border-border">
                                <th class="pb-3 pt-2 text-sm font-bold text-secondary uppercase tracking-wider w-5/12">Peserta Didik</th>
                                <th class="pb-3 pt-2 text-sm font-bold text-secondary uppercase tracking-wider w-3/12">NIS</th>
                                <th class="pb-3 pt-2 text-sm font-bold text-secondary uppercase tracking-wider w-3/12">Status</th>
                                <th class="pb-3 pt-2 text-right w-1/12">
